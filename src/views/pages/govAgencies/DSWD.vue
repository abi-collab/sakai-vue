...
<template>
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <br />
        <p><strong>Hospital Bill Assistance</strong>: up to PHP 10,000 for inpatient care and PHP 3,000 for outpatient care</p>
        <p><strong>Medication and Treatment Assistance</strong>: financial aid for prescribed medications and treatments</p>
        <p><strong>Medical Device and Assistive Device Support</strong>: support for medical devices, such as prosthetics and wheelchairs</p>
        ...
        <ul style="list-style-type: disc">
            ...
            <li>Laboratory Request or Doctor's Order (if applicable)</li>
        </ul>
        <p>&nbsp;</p>
